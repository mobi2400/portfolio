...
const AboutSection = () => {
  ...
  const renderQuotes = (): React.ReactNode => (
    <h1 ref={quoteRef} className="font-medium text-3xl sm:text-4xl md:text-6xl">
      ...
      >
        I am Md Mobasshir Shakil Khan, a community-first engineer who loves
        translating ambitious ideas into resilient MERN systems.
      </span>
      <span
      ...
      >
        Currently exploring automation for student collectives, API-first
        backends, and thoughtful developer experience improvements.
      </span>
      {/* Add Mobasshir's extended bio later */}
    </h1>
  );
